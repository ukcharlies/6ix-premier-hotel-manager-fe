...
const amenitiesData = [
  {
    ...
    image: getStaticAssetUrl("/marten-bjork-n_IKQDCyrG0-unsplash.jpg"),
    icon: (
  ...
  },
  {
    ...
    image: getStaticAssetUrl("/christian-lambert-vmIWr0NnpCQ-unsplash.jpg"),
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    image: getStaticAssetUrl("/vojtech-bruzek-Yrxr3bsPdS0-unsplash.jpg"),
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    image: getStaticAssetUrl("/bilderboken-rlwE8f8anOc-unsplash.jpg"),
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
  ...
  },
  {
    ...
    image: getStaticAssetUrl("/deluxe_room.jpg"),
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
